...
<template>
  <section class="ChurchesOutreachPage bg--color-cr-gray-lighter h-fit w-full flex-center flex-col">
    <div id="11001001" v-if="section1" class="w-full">
